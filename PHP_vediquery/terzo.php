<?php
   ...
   if(isset($_POST['I4']))
   {
      ...
      $query="";
      $query=$query."INSERT INTO Voti (voto,ID_Studenti) ";
      $query=$query."VALUES (".$v2.",".$v1.") ";
   }
?>
...
<BODY>
   ...
   <FORM name='F1' method='post' action='<?php echo $_SERVER['PHP_SELF']; ?>' >
	  ...
	  Voto: <INPUT type='text' name='V2' value='<?php echo $v2; ?>' size='3'>
 	  <INPUT type='submit' name='I4' value='invia'>
